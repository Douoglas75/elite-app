      ...
      <div className="absolute inset-0 z-[500] pointer-events-none flex flex-col justify-end">
        ...
        <div className="absolute top-1/2 right-4 -translate-y-1/2 flex flex-col gap-3 pointer-events-auto">
            ...
            <button 
              ...
              className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-2xl active:scale-95 transition-all border border-white/10 ${isLocating ? 'bg-blue-500 text-white animate-pulse' : 'bg-[#0D1625]/90 backdrop-blur-xl text-white'}`}
            >
